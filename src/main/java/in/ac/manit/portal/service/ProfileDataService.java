...
public class ProfileDataService {
	...
	public String addNewFaculty(String userID, String loginType, String imageURL, String userName, String userHandle,
			String userAbout, String branch, String batch, String pointer, String type, String contact, String email, String dob) {
		
		BasicDBObject in = new BasicDBObject() ;
		in.put("userID", userID) ;
		in.put("loginType", loginType) ;
		in.put("imageURL", imageURL) ;
		in.put("userName", userName) ;
		in.put("userHandle", userHandle) ;
		in.put("userAbout", userAbout) ;
		in.put("branch", branch) ;
		in.put("batch", batch) ;
		in.put("pointer", pointer) ;
		in.put("type", type) ;
		in.put("contact", contact) ;
		in.put("email", email) ;
		in.put("dob", dob) ;
		db.getCollection("userData").insert(in) ;
		
		BasicDBObject pn = new BasicDBObject() ;
		pn.put("userID",userID) ;
		pn.put("password", userID+batch) ;
		db.getCollection("userCredentials").insert(pn);
