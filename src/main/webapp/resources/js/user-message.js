$( document ).ready(function() {
    ...
    $("#submit-message").click(function() {
    	...
    	if(userID == null) {
        	...
        	console.log("Reciever: " + $("#namesF").val()) ;
        	
        	$("#form-userName").val($("#namesF option:selected").text()) ;
        	console.log($("#namesF option:selected").text()) ;
        	
        	$("#form-userProfileImage").val($("#namesF option:selected").attr("imageURL")) ;
        	console.log($("#namesF option:selected").attr("imageURL")) ;
