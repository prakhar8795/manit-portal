...
<div class="container-fluid">
	...
	<div id="user-message-container" class="row">
		<div class="col-md-3" style="height:82vh;overflow:auto;margin-top:10px;border-right: 1px solid black;">
			
			<div id="new-message" class="row message-block-container-new" style="padding:4px;">
		...
		<div id="new-message-container" class="col-md-8 hidden">
		...
		<div id="conversation-container" class="col-md-9 hidden">
			<div id="conversation-data" class="container-fluid" style="height:82vh;overflow:auto;margin-top:10px;">
